...
namespace {
    ...
    class Home extends Page
    {
        ...
        public function getCMSFields()
        {
            ...
            $fields->addFieldToTab("Root.Icon", DropdownField::create("IconOne", "Icon One", singleton("Home")->dbObject("IconOne")->enumValues()));
            $fields->addFieldToTab("Root.Icon", DropdownField::create("IconTwo", "Icon Two", singleton("Home")->dbObject("IconTwo")->enumValues()));
            $fields->addFieldToTab("Root.Icon", DropdownField::create("IconThree", "Icon Three", singleton("Home")->dbObject("IconThree")->enumValues()));
